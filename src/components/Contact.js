    ...
    return (
        <section className="min-h-[90vh] flex flex-col justify-center items-center">
            ...
            <div className="contact-browser mt-5">
                <div className="contact-browser-header flex items-center p-5 h-1/6">
                        ...
                        <div className='w-full h-full flex flex-col items-center'>
                            <div id="email-page" className='page' style={{ display: "block" }}>
                                ...
                                <div className="button flex flex-col items-center">
                                    <a id="email-button" className="rounded-3xl mt-5 px-6 py-1 flex gap-2 items-center hover:scale-105 ease-in" href='mailto:tarikabirch@gmail.com'>
                                        Send A Message
                                    </a>
                                </div>
                            </div>
                            ...
                            <div id="linkedin-page" className='page'>
                                ...
                                <p>tarika-birch</p>
                                <div className="button flex flex-col items-center">
                                    <a id="linkedin-button" className="rounded-3xl mt-5 px-6 py-1 flex gap-2 items-center hover:scale-105 ease-in" href='https://www.linkedin.com/in/tarika-birch/'>
                                        Connect With Me!
                                    </a>
                                </div>
                            </div>
                            ...
                            <div id="github-page" className='page'>
                                ...
                                <p>taigati</p>
                                <div className="button flex flex-col items-center">
                                    <a id="github-button" className="rounded-3xl mt-5 px-6 py-1 flex gap-2 items-center hover:scale-105 ease-in" href='https://github.com/taigati'>
                                        View GitHub
                                    </a>
                                </div>
                            </div>
                            ...
                            <div id="medium-page" className='page'>
                                ...
                                <p>tarikabirch</p>
                                <div className="button flex flex-col items-center">
                                    <a id="medium-button" className="rounded-3xl mt-5 px-6 py-1 flex gap-2 items-center hover:scale-105 ease-in" href='https://medium.com/@tarikabirch'>
                                        Read Blog
                                    </a>
                                </div>
                            </div>
                            ...
                            <div id="youtube-page" className='page'>
                                <div className="animation opacity-70">
                                    <img src="assets/contact-animations/youtube.gif" alt="Youtube" width={200} />
                                </div>
                                <p>Technically Ti</p>
                                <div className="button flex flex-col items-center">
                                    <a id="youtube-button" className="rounded-3xl mt-5 px-6 py-1 flex gap-2 items-center hover:scale-105 ease-in" href="https://www.youtube.com/channel/UCuUPNYwnqCY2eSfPmztEsng?sub_confirmation=1">
                                        Subscribe
                                    </a>
                                </div>
                            </div>
            ...
            <div className='resume-button-container my-2 flex flex-col items-center gap-2'>
