...
function Projects() {
    return (
        <div className="projects flex flex-col items-center p-10 min-h-[90vh]">
            ...
            <div className="projects-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-12">
                <ProjectPreview />
                <ProjectPreview />
                <ProjectPreview />
                <ProjectPreview />
